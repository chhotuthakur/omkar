...
public class FirebaseVendorAdapter extends FirebaseRecyclerAdapter<Vendors, FirebaseVendorAdapter.productViewHolder> {



    public FirebaseVendorAdapter(@NonNull FirebaseRecyclerOptions<Vendors> options) {
        super(options);
    }
